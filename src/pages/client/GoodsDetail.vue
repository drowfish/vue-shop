<template>
  <div class="GoodsDetail">
    <div class="content">
      <div class="goodsInfo">
        <img class="infoLeft" :src="baseimgurl+goodsImg" alt="商品图片" />
        <div class="infoRight">
          <div class="infoBox">
          ...
          <div v-if="commentList.length>0">
            ...
            <ul class="commentList">
              <li v-for="(item,index) in commentList" :key="'comment'+index">
                <div class="userInfo">
                  <img :src="baseimgurl+item.user.headimg" />
          ...
          <ul class="msgList">
            <li v-for="(item,index) in msgList" :key="'msg'+item.id">
              <div class="ask">
                ...
                <span class="tipsInfo">{{item.user.nickname+' '+item.createtime}}</span>
              </div>
              <div class="answer">
                <span class="note">答</span>
                <span class="text">{{item.reply != null?item.reply.content:'暂时没有回答'}}</span>
                <span class="tipsInfo">{{item.reply != null?item.reply.createtime:''}}</span>
              </div>
            </li>
          </ul>
        </div>
      ...
      <section class="typeGoods rightContainer">
        ...
        <ul class="list">
          <GoodsItem 
            ...
            :key="item.id"
            :id="item.id"
            :img="baseimgurl+item.img"
            :name="item.name"
            :price="item.list[0].unitprice"
          />
      </ul>
      </section>
    </div>
