      ...
      <div class="content">
        <div class="left">
          ...
          <div class="allBtn">查看全部 ></div>
            ...
            <img class="leftImg" :src="baseimgurl+item.img" />
            <div class="rightBox">
              ...
              <div class="price">
                <span class="nowPrice">限时价¥{{item.list[0].unitprice}}</span>
                <span class="beforePrice">原价¥{{item.list[0].unitprice+60}}</span>
              </div>
    ...
    <section class="hotGoods section">
      ...
      <div class="content">
        <ul class="left">
          <GoodsItem 
            :id="goodsList[0].id"
            :img="baseimgurl+goodsList[0].img"
            :name="goodsList[0].name"
            :price="goodsList[0].list[0].unitprice"
          />
        </ul>
        <ul class="right">
           <GoodsItem 
